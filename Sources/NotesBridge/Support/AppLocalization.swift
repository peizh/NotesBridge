...
struct AppLocalization: Sendable {
    ...
    private static let translations: [String: [String: String]] = [
        "zh-Hans": [
            ...
            "Synced %lld changed note(s), moved %lld note(s) to _Removed, and left %lld note(s) unchanged.": "已同步 %lld 条变更笔记，将 %lld 条笔记移到 _Removed，并保留 %lld 条未变化笔记。",
        ...
        "fr": [
            ...
            "Synced %lld changed note(s), moved %lld note(s) to _Removed, and left %lld note(s) unchanged.": "%lld note(s) modifiée(s) synchronisée(s), %lld note(s) déplacée(s) vers _Removed, %lld note(s) inchangée(s).",
